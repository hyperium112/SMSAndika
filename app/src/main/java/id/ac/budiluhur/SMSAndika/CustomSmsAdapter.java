...
public class CustomSmsAdapter extends ArrayAdapter<Sms> implements View.OnClickListener{
    ...
    public CustomSmsAdapter(ArrayList<Sms> data, Context context) {
        super(context, id.ac.budiluhur.SMSAndika.R.layout.item_sms, data);
        this.dataSet = data;
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if (convertView == null) {
            ...
            convertView = inflater.inflate(id.ac.budiluhur.SMSAndika.R.layout.item_sms, parent, false);
            viewHolder.txtPhone = (TextView) convertView.findViewById(id.ac.budiluhur.SMSAndika.R.id.txtPhone);
            viewHolder.txtMessage = (TextView) convertView.findViewById(id.ac.budiluhur.SMSAndika.R.id.txtMessage);
            viewHolder.txtDate = (TextView) convertView.findViewById(id.ac.budiluhur.SMSAndika.R.id.txtDate);

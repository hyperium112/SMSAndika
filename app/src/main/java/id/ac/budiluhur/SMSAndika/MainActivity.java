...
public class MainActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(id.ac.budiluhur.SMSAndika.R.layout.activity_main);
        ...
        etPhone = (EditText) findViewById(id.ac.budiluhur.SMSAndika.R.id.editTextPhone);
        etMessage = (EditText) findViewById(id.ac.budiluhur.SMSAndika.R.id.editTextMessage);
        btnInbox = (Button) findViewById(id.ac.budiluhur.SMSAndika.R.id.btnInbox);
        btnSent = (Button) findViewById(id.ac.budiluhur.SMSAndika.R.id.btnSent);
        btnKirim = (Button) findViewById(id.ac.budiluhur.SMSAndika.R.id.btnKirim);
    ...
    public void onClick(View view) {
        switch (view.getId()) {
            case id.ac.budiluhur.SMSAndika.R.id.btnInbox:
                Intent i1 = new Intent(this, InboxActivity.class);
                startActivity(i1);
                break;

            case id.ac.budiluhur.SMSAndika.R.id.btnSent:
                Intent i2 = new Intent(this, SentActivity.class);
                startActivity(i2);
                break;

            case id.ac.budiluhur.SMSAndika.R.id.btnKirim:
